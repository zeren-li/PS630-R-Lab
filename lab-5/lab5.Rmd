...
* Rule of thumb: If $VIF_j$ is above 10 (equivalently, $R^2_j$ is above .9), then we conclude that multicollinearity is a “problem” for estimating bj. But a $VIF_j$ above 10 does not mean that the standard deviation of $b^j$ is too large to $b$

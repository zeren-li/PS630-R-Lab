...
6. Again, manually perform a two-sample t-test comparing of the number of previous jobs (`ofjobs`) between applicants with black sounding names and white sounding names.  Double check your results using the built-in `t.test` command in R. Do you find differences in call back rates by race? (2 points)
